...
In social sciences, researchers often collect or utilize spatial data to [analyze patterns]{.emphasize}, relationships, and distributions [across geographic areas]{.emphasize}.
...
- There are a ton of [geographical file formats](https://gisgeography.com/gis-formats/), but here are some that are particularly popular.
...
Find all the health and social services network establishments within 5 km of **Vanier**.
...
[Example: mental health survey across various campuses.]{.emphasize}
